      ...
      {!user ? (
        ...
        <>
          ...
          <ul className={styles['inputs']}>
            <li className={styles['inputs-item']}>
              ...
              <input
                ...
                placeholder='Title'
                className={
                  errors.title ? `${styles['inputs-item-input']} ${styles.error}` : styles['inputs-item-input']
                }
                {...register('title', {
            ...
            <li className={styles['inputs-item']}>
              ...
              <input
                ...
                className={
                  errors.description ? `${styles['inputs-item-input']} ${styles.error}` : styles['inputs-item-input']
                }
            ...
            <li className={styles['inputs-item']}>
              ...
              <textarea
                ...
                className={
                  errors.text
                    ? `${styles['inputs-item-input']} ${styles.description} ${styles.error}`
                    : `${styles['inputs-item-input']} ${styles.description}`
                }
          ...
          <div className={styles['form__list-tags']}>
            <div className={styles['form__tags']}>
              {fields.map((item, index) => (
                <div key={uuidv4()} className={styles['form__tagWithDelete']}>
                  ...
                  />
                  <button
                    className={` ${styles['create-article__btn']} ${styles['form__delete']}`}
                    type='button'
            ...
            <button
              className={` ${styles['create-article__btn']} ${styles['form__add']}`}
              type='button'
              onClick={() => append('')}
            >
              Add tag
