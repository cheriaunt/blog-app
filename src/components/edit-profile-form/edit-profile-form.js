        ...
        <form onSubmit={handleSubmit((data) => onSubmit(data))}>
            ...
            <ul className={styles['inputs']}>
                <li className={styles['inputs-item']}>
                    ...
                    <input type='text' id={'username'} placeholder='Username'  autoComplete='current-username' className={errors.username ? `${styles['inputs-item-input']} ${styles.error}`: styles['inputs-item-input']} {...register('username', {
                ...
                <li className={styles['inputs-item']}>
                    ...
                    <input type='text' id='email' placeholder='Email address' autoComplete='current-email' className={errors.email ? `${styles['inputs-item-input']} ${styles.error}`: styles['inputs-item-input']} {...register('email', { required: 'Please input your email!' })}/>
                ...
                <li className={styles['inputs-item']}>
                    ...
                    <input type='password' id='new password' placeholder='New password' autoComplete='current-password' className={errors.password ? `${styles['inputs-item-input']} ${styles.error}`: styles['inputs-item-input']} {...register('password', {
