            ...
            <form onSubmit={handleSubmit((data) => onSubmit(data))}>
                ...
                <ul className={styles['inputs']}>
                    <li className={styles['inputs-item']}>
                        ...
                        <input type='text' id='username' placeholder='Username' autoComplete='username' className={errors.username ? `${styles['inputs-item-input']} ${styles.error}`: styles['inputs-item-input']} {...register('username', {
                    ...
                    <li className={styles['inputs-item']}>
                        ...
                        <input type='text' id='email' placeholder='Email address' className={errors.email ? `${styles['inputs-item-input']} ${styles.error}`: styles['inputs-item-input']} {...register('email', { required: 'Please input your email!' })}/>
                    ...
                    <li className={styles['inputs-item']}>
                        ...
                        <input type='password' id='password' placeholder='Password' suggested='new-password' autoComplete='current-password' className={errors.password ? `${styles['inputs-item-input']} ${styles.error}`: styles['inputs-item-input']} {...register('password', {
                    ...
                    <li className={styles['inputs-item']}>
                    <label htmlFor='repeatPassword' >Password
                        </label>
                        <input type='password' id='repeatPassword' placeholder='Repeat Password' suggested='new-password' autoComplete='current-password' className={errors.repeatPassword ? `${styles['inputs-item-input']} ${styles.error}`: styles['inputs-item-input']}  {...register('repeatPassword', {
